 ...
 * - Asumsikan semua input pada test-case mengikuti batasan format object yang sudah dijelaskan diatas
...
function mercRecruiter(mercenary) {
    var score = 0;
    var name = mercenary.name;
    var skills = mercenary.skills;
    var weapons = mercenary.weapons;
