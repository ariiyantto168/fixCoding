...
function getMoneyChange(mauDiTukar) {
  ...
  for (let i = 0; i < uang.length; i++) {
    while (moneyStocks[uang[i]] != 0 && mauDiTukar - uang[i] >= 0) {
      ...
      mauDiTukar -= uang[i];
      obj[uang[i]] += 1;    // console.log('Maaf uang kembalian tidak cukup');
    }
  }
...
console.log("50000 1 lembar");
console.log("20000 1 lembar");
console.log("5000 1 lembar");
    // 5000 1 lembar
...
/*
    ...
    20000 2 lembar
*/
console.log("100000 1 lembar");
console.log("50000 1 lembar");
console.log("20000 2 lembar");
...
/*
    20000 1 lembar
    10000 5 lconsole.log('10000 5 lembar');embar
    5000 4 lembar
    1000 10 lembar
*/

console.log('20000 1 lembar');
console.log('10000 5 lembar');
console.log('10000 5 lembar');
// console.log('');
console.log('CASE 5:\n----------------');
getMoneyChange(400);
